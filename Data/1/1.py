...
RA_5=LLayer12/TCP(sport=port[1],dport=port[2],flags="P"+"A",seq=11,ack=108,window=50)/("12345678")
RA_6=LLayer21/TCP(sport=port[2],dport=port[1],flags="A",seq=108,ack=19,window=100)
#Storage packets
pkt=[]
