...
RA_10=LLayer21/TCP(sport=port[2],dport=port[1],flags="F"+"A",seq=121,ack=11,window=100)
RA_11=LLayer12/TCP(sport=port[1],dport=port[2],flags="A",seq=11,ack=122,window=50)
RA_12=LLayer12/TCP(sport=port[1],dport=port[2],flags="F"+"A",seq=11,ack=122,window=50)
RA_13=LLayer21/TCP(sport=port[2],dport=port[1],flags="A",seq=122,ack=12,window=100)
...
RP_10=LLayer12/TCP(sport=port[1],dport=port[2],flags="F"+"A",seq=27,ack=101,window=50)
RP_11=LLayer21/TCP(sport=port[2],dport=port[1],flags="A",seq=101,ack=28,window=100)
RP_12=LLayer21/TCP(sport=port[2],dport=port[1],flags="F"+"A",seq=101,ack=28,window=100)
RP_13=LLayer12/TCP(sport=port[1],dport=port[2],flags="A",seq=28,ack=102,window=50)
#Storage packets
pkt=[]
...
pkt.append(RA_10);pkt.append(RA_11);pkt.append(RA_12)
pkt.append(RA_13);#pkt.append(RA_8);pkt.append(RA_9)
wrpcap("1.pcap",pkt)
...
pkt.append(RP_10);pkt.append(RP_11);pkt.append(RP_12)
pkt.append(RP_13);#pkt.append(RP_8);pkt.append(RP_9)
wrpcap("2.pcap",pkt)
